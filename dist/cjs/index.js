...
function Button_slide(props) {
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("button", { className: "".concat(props.padding === "xs" ? "padding-xs" : "").concat(props.padding === "s" ? "padding-s" : "").concat(props.padding === "m" ? "padding-m" : "").concat(props.padding === "l" ? "padding-l" : "").concat(props.padding === "xl" ? "padding-xl" : "").concat(props.padding === "xxl" ? "padding-xxl" : "", " ").concat(props.hover_effect === "slide-down"
                ? "btn_hover_slide slide_down"
                ...
                ? "btn_hover_slide slide_left"
                : "", " ") },
            React__default["default"].createElement("span", { className: "".concat(props.iconPosition === "left" ? "reverse" : "") },
                props.text,
                props.icon ? React__default["default"].createElement("div", { className: "icon" }, props.icon) : ""))));
}
...
function Description(props) {
    return (React__default["default"].createElement("div", { className: "a-description ".concat(props.underline ? "underline" : "", " ").concat(props.italic ? "italic" : ""), style: __assign$1({ "--a-description-color": props.color }, props.style) }, props.text));
}
...
function Label(props) {
    return (React__default["default"].createElement("div", { className: "a-label", style: __assign$1({ "--a-label-color": props.color, "--a-label-background-color": props.backgroundColor }, props.style) }, props.text));
}
...
function Footer_link(props) {
    return (React__default["default"].createElement("div", { className: "a-footer-link" },
        props.link_type === "main" ? (React__default["default"].createElement("div", { className: "main-link" }, props.link)) : (""),
        props.link_type === "secondary" ? (React__default["default"].createElement("div", { className: "secondary-link" }, props.link)) : ("")));
}
...
function Logo(props) {
    return (React__default["default"].createElement("div", { className: "a-logo", style: __assign$1(__assign$1({ "--a-logo-border-radius": props["border-radius"], "--a-logo-background": props.background }, props.style), { background: "".concat(extraColor) }) }, props.logo));
}
...
function Footer_link_list(props) {
    return (React__default["default"].createElement("div", { className: "m-footer-link-list ".concat(props.position == 'center' ? 'center' : '').concat(props.position == 'right' ? 'right' : '') }, props.link_element));
}
//test
...
function Footer_card(props) {
    return (React__default["default"].createElement("div", { className: "footer-card-container" },
        React__default["default"].createElement("div", { className: "logo" }, props.logo),
        React__default["default"].createElement("div", { className: "description" }, props.description),
        React__default["default"].createElement("div", { className: "action" }, props.action)));
}
...
function Card(props) {
    var imageElement = props.image ? (React__default["default"].createElement("div", { className: "image" }, props.image)) : null;
    var labelsElement = props.labels ? (React__default["default"].createElement("div", { className: "labels" }, props.labels)) : null;
    var titleElement = props.title ? (React__default["default"].createElement("div", { className: "title" }, props.title)) : null;
    var descriptionElement = props.description ? (React__default["default"].createElement("div", { className: "description" }, props.description)) : null;
    var buttonsElement = props.buttons ? (React__default["default"].createElement("div", { className: "buttons" }, props.buttons)) : null;
    ...
    return (React__default["default"].createElement("div", { className: "card-container" },
        React__default["default"].createElement("div", { className: "m-card ".concat(isOverlapped, " ").concat(cardImageClass) },
            imageElement,
            React__default["default"].createElement("div", { className: "content" },
                labelsElement,
                titleElement,
...
function Title_and_description(props) {
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { className: "m-title-and-description ".concat(props.text_align === "center" ? 'center' : '', " ").concat(props.text_align === "right" ? "right" : '') },
            props.label ? React__default["default"].createElement("div", { className: "label" }, props.label) : "",
            ...
            props.action ? React__default["default"].createElement("div", { className: "action" }, props.action) : "")));
}
...
function Media(props) {
    ...
    var _d = React.useState((_a = props["show-controls"]) !== null && _a !== void 0 ? _a : false), showControls = _d[0], setShowControls = _d[1];
    ...
    return (React__default["default"].createElement("div", { className: "a-media", onMouseMove: handleMouseMove, onMouseLeave: handleMouseLeave }, props.video ? (React__default["default"].createElement("div", { className: "a-media__video", style: __assign$1({ "--a-video-border-radius": props["video-border-radius"] }, props.style) },
        React__default["default"].createElement("div", { className: "video-container" },
            React__default["default"].createElement("video", { src: props.video, ref: videoRef, style: __assign$1({ width: "100%", "--a-video-object-fit": props["object-fit"] }, props.style), autoPlay: props["remove-controls"] || props["auto-play"], muted: !!(props["remove-controls"] || props.muted), loop: props.loop })),
        React__default["default"].createElement("div", { className: "progress-line-container", style: __assign$1({ "--a-video-progress-line-background": props["progress-bar-color"] }, props.style) },
            React__default["default"].createElement("div", { className: "progress-line", style: { width: "".concat(progress, "%") } })),
        props["remove-controls"] ? null : (showControls && (React__default["default"].createElement(React__default["default"].Fragment, null,
            React__default["default"].createElement("div", { className: "fullscreen-icon" }, props["custom-fullscreen-icon"] ? (React__default["default"].createElement("div", { onClick: handleFullscreen }, props["custom-fullscreen-icon"])) : (React__default["default"].createElement(BsArrowsFullscreen, { onClick: handleFullscreen, className: "controls-icon" }))),
            React__default["default"].createElement("div", { className: "controls-container" },
                React__default["default"].createElement("div", { className: "controls" },
                    React__default["default"].createElement("div", { className: "icon-container" }, props["custom-prev-icon"] ? (React__default["default"].createElement("div", { onClick: revert }, props["custom-prev-icon"])) : (React__default["default"].createElement(AiOutlineStepBackward, { className: "controls-icon", onClick: revert }))),
                    playing ? (React__default["default"].createElement("div", { className: "icon-container" }, props["custom-pause-icon"] ? (React__default["default"].createElement("div", { onClick: function () { return videoHandler("pause"); } }, props["custom-pause-icon"])) : (React__default["default"].createElement(FiPauseCircle, { onClick: function () { return videoHandler("pause"); }, className: "controls-icon action-icon" })))) : (React__default["default"].createElement("div", { className: "icon-container" }, props["custom-play-icon"] ? (React__default["default"].createElement("div", { onClick: function () { return videoHandler("play"); } }, props["custom-play-icon"])) : (React__default["default"].createElement(FaPlay, { onClick: function () { return videoHandler("play"); }, className: "controls-icon action-icon" })))),
                    React__default["default"].createElement("div", { className: "icon-container" }, props["custom-next-icon"] ? (React__default["default"].createElement("div", { onClick: fastForward }, props["custom-next-icon"])) : (React__default["default"].createElement(AiOutlineStepForward, { className: "controls-icon", onClick: fastForward })))))))))) : (React__default["default"].createElement("div", { className: "a-media__image", style: __assign$1({ "--a-media-image-border-radius": props["image-border-radius"] }, props.style) },
        props["label-top-left"] && React__default["default"].createElement("div", { className: "label top-left" }, props["label-top-left"]),
        props["label-top-right"] && React__default["default"].createElement("div", { className: "label top-right" }, props["label-top-right"]),
        props["label-bottom-left"] && React__default["default"].createElement("div", { className: "label bottom-left" }, props["label-bottom-left"]),
        props["label-bottom-right"] && React__default["default"].createElement("div", { className: "label bottom-right" }, props["label-bottom-right"]),
        props.image))));
}
...
function Divider(props) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { ref: dividerRef, className: "m-divider ".concat(props.vertical ? "vertical" : "", " ").concat(props.position), style: __assign$1({ "--m-divider-width": props.width }, props.style) }, props.divider)));
}
...
exports.Footer_card = Footer_card;
exports.Footer_link = Footer_link;
exports.Footer_link_list = Footer_link_list;
exports.Label = Label;
exports.Logo = Logo;
exports.Media = Media;
exports.Simple_Divider = SimpleDivider;
exports.Title_and_description = Title_and_description;
