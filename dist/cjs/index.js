...
function Label(props) {
    return (React__default["default"].createElement("div", { className: "a-label", style: __assign({ '--a-label-color': props.color, '--a-label-background-color': props.backgroundColor }, props.style) }, props.text));
}
