...
function Media(props) {
    ...
    var _d = React.useState((_a = props.showControlsProperty) !== null && _a !== void 0 ? _a : false), showControls = _d[0], setShowControls = _d[1];
    ...
    return (React__default["default"].createElement("div", { className: "a-media", onMouseMove: handleMouseMove, onMouseLeave: handleMouseLeave }, props.video ? (React__default["default"].createElement("div", { className: "a-media__video" },
        React__default["default"].createElement("div", { className: "video-container" },
            React__default["default"].createElement("video", { src: props.video, ref: videoRef, style: __assign$1({ width: "100%", "--a-video-object-fit": props["object-fit"] }, props.style), autoPlay: props.hideShowControls || props["auto-play"], muted: !!(props.hideShowControls || props.muted), loop: props.loop })),
        ...
        props.hideShowControls ? null : (showControls && (React__default["default"].createElement(React__default["default"].Fragment, null,
            props["fullscreen-icon-color"] && (React__default["default"].createElement("div", { className: "fullscreen-icon" },
                React__default["default"].createElement(BsArrowsFullscreen, { style: { color: props["fullscreen-icon-color"] }, onClick: handleFullscreen, className: "controls-icon" }))),
            React__default["default"].createElement("div", { className: "controls-container" },
                React__default["default"].createElement("div", { className: "controls" },
                    React__default["default"].createElement("div", { className: "icon-container" },
                        React__default["default"].createElement(AiOutlineStepBackward, { style: { color: props["prev-icon-color"] }, className: "controls-icon", onClick: revert })),
                    playing ? (React__default["default"].createElement("div", { className: "icon-container" },
                        React__default["default"].createElement(FiPauseCircle, { style: { color: props["pause-icon-color"] }, onClick: function () { return videoHandler("pause"); }, className: "controls-icon action-icon" }))) : (React__default["default"].createElement("div", { className: "icon-container" },
                        React__default["default"].createElement(FaPlay, { style: { color: props["play-icon-color"] }, onClick: function () { return videoHandler("play"); }, className: "controls-icon action-icon" }))),
                    React__default["default"].createElement("div", { className: "icon-container" },
                        React__default["default"].createElement(AiOutlineStepForward, { style: { color: props["forward-icon-color"] }, className: "controls-icon", onClick: fastForward }))))))))) : (React__default["default"].createElement("div", { className: "a-media__image" },
