...
function Media(props) {
    ...
    var _d = useState((_a = props.showControlsProperty) !== null && _a !== void 0 ? _a : false), showControls = _d[0], setShowControls = _d[1];
    var rafRef = useRef(0);
    ...
    return (React.createElement("div", { className: "a-media", onMouseMove: handleMouseMove, onMouseLeave: handleMouseLeave }, props.video ? (React.createElement("div", { className: "a-media__video" },
        React.createElement("div", { className: "video-container" },
            React.createElement("video", { src: props.video, ref: videoRef, style: __assign$1({ width: "100%", "--a-video-object-fit": props["object-fit"] }, props.style), autoPlay: props.hideShowControls || props["auto-play"], muted: !!(props.hideShowControls || props.muted), loop: props.loop })),
        ...
        props.hideShowControls ? null : (showControls && (React.createElement(React.Fragment, null,
            props["fullscreen-icon-color"] && (React.createElement("div", { className: "fullscreen-icon" },
                React.createElement(BsArrowsFullscreen, { style: { color: props["fullscreen-icon-color"] }, onClick: handleFullscreen, className: "controls-icon" }))),
            React.createElement("div", { className: "controls-container" },
                React.createElement("div", { className: "controls" },
                    React.createElement("div", { className: "icon-container" },
                        React.createElement(AiOutlineStepBackward, { style: { color: props["prev-icon-color"] }, className: "controls-icon", onClick: revert })),
                    playing ? (React.createElement("div", { className: "icon-container" },
                        React.createElement(FiPauseCircle, { style: { color: props["pause-icon-color"] }, onClick: function () { return videoHandler("pause"); }, className: "controls-icon action-icon" }))) : (React.createElement("div", { className: "icon-container" },
                        React.createElement(FaPlay, { style: { color: props["play-icon-color"] }, onClick: function () { return videoHandler("play"); }, className: "controls-icon action-icon" }))),
                    React.createElement("div", { className: "icon-container" },
                        React.createElement(AiOutlineStepForward, { style: { color: props["forward-icon-color"] }, className: "controls-icon", onClick: fastForward }))))))))) : (React.createElement("div", { className: "a-media__image" },
