...
function Testing(props) {
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "test-container", style: { color: "red" } }, props.test)));
}
...
export { Button_Line_Drawing, Button_Slide_Second, Button_slide, FAQ_item, Testing };
